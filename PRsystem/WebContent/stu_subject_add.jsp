...
<div id="wrapper">
		...
		<input type="hidden" name="num" value="">				
			<div class="form-group">
				 <label class="col-sm-3 control-label" for="login_username">과목코드</label>
					<div class="col-sm-3">
					<input id="Register_email" name="userid1" type="email" class="form-control" placeholder="과목코드"required> 
					<span id="mail_check" class="check_image"></span>
					</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label" for="login__username">분반</label>
				<div class="col-sm-1">
				 <input id="Register_name" name="name" type="text" class="form-control" placeholder="분반" required>
			...
			<button class="btn btn-default" onclick="valid_check()">추가하기</button>
