   ...
   <!-- Navigation -->
	...
	<div id="page-wrapper">
		...
		<input type="hidden" name="num" value="">				
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="login__username">패스워드 확인</label> 
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="login__university">소 속 </label> 
				<div class="col-sm-3">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label" for="login__username">학 번</label> 
				<div class="col-sm-3">
			...
			<div class="form-group">
			<label class="col-sm-3 control-label" for="login__gender"> 성별  </label>
			<div class="col-sm-3">
			...
			<div class="form-group">
			<label class="col-sm-3 control-label" for="login__career"> 직업  </label>
			<div class="col-sm-3">
			...
			<div class="form-group">	
			<label class="col-sm-3 control-label" for="login__image"> 내 이미지  </label>
			<div class="col-sm-3">
